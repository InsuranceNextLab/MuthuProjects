...
public class Appsettings {
	...
	public static final String IP_ADDRESS = "54.164.71.138:8088";
	public static final String REGISTER_URL = "http://54.164.71.138:8088/claimadjuster/ClaimRequest.php";
