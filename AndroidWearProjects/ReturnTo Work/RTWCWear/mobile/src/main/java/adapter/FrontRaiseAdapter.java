 ...
 */
public class FrontRaiseAdapter extends BaseAdapter {

    public final static Bundle data = new Bundle();
    private ArrayList<FrontRaiseCount> listdetails;
    private LayoutInflater mInflater;
    private Context activity;

    public FrontRaiseAdapter(ArrayList<FrontRaiseCount> listcollection,
                             Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vi = mInflater.inflate(R.layout.frontraise_row, null);
        ...
        holder.step_count.setText(listdetails.get(position).getFrontRaiseCount());
        holder.step_time.setText(listdetails.get(position).getFrontRaiseTime());
