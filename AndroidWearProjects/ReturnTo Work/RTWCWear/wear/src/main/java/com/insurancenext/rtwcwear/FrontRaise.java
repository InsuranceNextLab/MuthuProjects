...
import com.insurancenext.rtwcwear.view.FrontRaiseView;
import com.insurancenext.rtwcwear.view.SplitTimeView;

import java.util.concurrent.TimeUnit;

public class FrontRaise extends Activity implements SensorEventListener, Stopwatch.OnTickListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, UserInputManager.UserInputListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stub.setOnLayoutInflatedListener(new WatchViewStub.OnLayoutInflatedListener() {
            ...
            public void onLayoutInflated(WatchViewStub stub) {
                mTextView = (TextView) stub.findViewById(R.id.frontraise);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (source.getType() == Sensor.TYPE_GRAVITY) {
            if (up_flag && z > POSITIVE_GRAVITY_Z_THRESHOLD) {
                frontraiseCounter++;
                Log.d("frontraiseCounter", frontraiseCounter + "");
                mTextView.setText(String.valueOf(frontraiseCounter));
                up_flag = false;
    ...
    public void onTick(long elapsed) {
        ...
        Log.i("elapsed", elapsed + "" + frontraiseCounter);
        if(timeSeconds>=9 && frontraiseCounter>0) {
            this.showNotification(frontraiseCounter);
        }
    }
    ...
    protected void stopWorkout() {
        this.stopwatch.stop();
        if (frontraiseCounter > 0) {
            datamap.putString("step_count", frontraiseCounter + "");
