...
public class RoofActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rooftype);
        context = this;
        ...
        // if (Appsettings.getString(context, "roof_type") != null) {
        // surevy_details.setText(Appsettings.getString(context, "roof_type"));
        // }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Appsettings.putString(context, "roof_type", extend_damage);
    ...
    private GestureDetector createGestureDetector(RoofActivity claimdetails_info) {
        ...
        gestureDetector.setBaseListener(new GestureDetector.BaseListener() {
            public boolean onGesture(Gesture gesture) {
                if (gesture == Gesture.TAP) {
                    ...
                    startActivity(new Intent(context, CausedemageActivity.class));

                } else if (gesture == Gesture.SWIPE_LEFT) {
                    // startActivity(new Intent(context, ExtentActivity.class));
                    finish();
