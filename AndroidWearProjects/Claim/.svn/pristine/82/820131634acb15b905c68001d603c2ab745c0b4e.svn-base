...
public class Claimdetails_info extends Activity implements OnItemClickListener {
	...
	String[] policy_number = new String[] { "AU-00010001", "AU-00010004",
	...
	String[] cause_loss = new String[] { "Loss due to flood", "Fire Accident",
			"Water Leakage", "Earthquake", "Theft", "Theft" };
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		data.putString("policy_number", claim_list.get(position)
				.getPolicyNumber());
