...
.knowMore {
	background: url(../images/see-more-button.png) no-repeat;
}
#head {
    display: block;
    height: 123px;
...
h2 { margin-top: 50px;}
  ...
  #sign_up,#agentDetail {
    ...
    #sign_up #sign_up_form,#agentDetail #agentPage {
        margin-top: 13px;
    }
    #sign_up label,#agentDetail label {
        display: block;
        margin-bottom: 10px;
        color: #536376;
        font-size: .9em;
    ...
    #coBrowsingInstructions #coBrowsingInstructions {
        margin-top: 13px;
    }
    #coBrowsingInstructions label {
        display: block;
        margin-bottom: 10px;
        color: #536376;
        font-size: .9em;
    ...
    #coBrowsingInstructions label input {
        display: block;
        width: 393px;
        height: 31px;
        background-position: -201px 0;
